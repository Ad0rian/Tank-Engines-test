...
namespace Tank2DControllers
{
    ...
    {
        //If the player will aim with mouse or not.
        public bool MouseAim;
        //Set the tank animator movement.
        private Animator anim;

        void Start()
        {
            //Get the tank animator.
            anim = GetComponent<Animator>();
        }

        //Get the tankrigidbody.
        ...
        //Get the vehicle rotation speed.
        ...
        //Get the current turret rotation.
        ...
        //Get the direction of the tank movement.
        ...
        //Types of rotation effect movement.
        public enum RotorRotationMethod
        {
            None, RotateTowards, Lerp, Slerp, SmoothDamp
        }
        ...
        private float GetHorizontalInput()
        {
            ...
            if (Mathf.Abs(horizontal) > 0) return keyboardInvertHorizontal ? -horizontal : horizontal;
        ...
        private float GetVerticalInput()
        {
            ...
            //If currently moving with the keyboard, return the input.
            if (Mathf.Abs(vertical) > 0) return keyboardInvertVertical ? -vertical : vertical;
        ...
        private void OverrideInput(ref float targetSpeed){if (targetSpeed.IsZero()) return;}
        ...
        //Get the tank shoot system script.
        public Tank2DShootSystem weapon;

        private void Update()
        {
            //Set speed float magnitude.
            ...
            //Fire Shoot.
            if(Input.GetButtonDown(ShootInput))weapon.Shoot();
            //Invoke Shield Ability.
            if(Input.GetButtonDown(ShieldInput))weapon.Shield();         
        }

        //Processes the users input by moving the character
        private void FixedUpdate(){ProcessInput();}        
    }
}